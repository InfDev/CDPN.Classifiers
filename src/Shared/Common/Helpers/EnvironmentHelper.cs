...
#pragma warning disable CA1707
    ...
    public static class EnvironmentHelper
    {
        ...
        public static string GetPortableRID(string[] supportedRIDs)
        {
            var rid = GetPortableRID();
            if (supportedRIDs == null || !supportedRIDs.Contains(rid))
                throw new NotSupportPlatformException(rid, supportedRIDs);
            return rid;
        }
    }
}
