...
#pragma warning disable CS1572 // Комментарий XML содержит тег param, но параметр с таким именем не существует
        ...
        public CountriesController(ClassifiersContext dbContext)
        {
        ...
        /// <summary>
        /// Страны постранично с возможностями сортировки и фильтрации
        /// </summary>
        ...
        public async Task<WidePaging<Country>> GetCountries([FromQuery] GridifyQuery gQuery)
        {
            var pagingResult = await _dbContext.Countries.GridifyAsync(gQuery);
