...
#pragma warning disable CS1572 // Комментарий XML содержит тег param, но параметр с таким именем не существует
        ...
        public CurrenciesController(ClassifiersContext dbContext)
        {
        ...
        /// <summary>
        /// Валюты постранично с возможностями сортировки и фильтрации
        /// </summary>
        ...
        public async Task<WidePaging<Currency>> GetCurrencies([FromQuery] GridifyQuery gQuery)
        {
            var pagingResult = await _dbContext.Currencies.GridifyAsync(gQuery);
